...
function spiderChart(data, equipment, lift){
  ...
  scatterList = createSpiderData(data, equipment, lift)[0]
  scatterListMen = createSpiderData(data, equipment, lift)[1]
  scatterListWomen = createSpiderData(data, equipment, lift)[2]
  ...
  var svg = createSpiderSVG(w, h)

  makeLegend(svg, w, colorscale)
}

/**
 * Creates formatted data for contesters under 18
 */
...
/**
 * Creates formatted data for lifters between two ages
 */
...
/**
 * Creates formatted data for lifters over the age of 64
 */
...
/**
 * Creates formatted data for all lifters
 */
function createSpiderData(data, equipment, lift){
  ...
  return [scatterList, scatterListMen, scatterListWomen]
}

function createSpiderSVG(w, h){
